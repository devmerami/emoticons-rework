...
public class ClientModel extends Model {
	...
	public void loadMeshData() {
		try {
			...
			System.err.println(ResourceLocationUtils.getPath(location) + " failed to load!");
		}
	}
	...
	public void draw(VisibleMatrix4f[] poses) {
		...
		for(int i = 0; i < this.mesh.vertexCount; i++) {
			...
			Vec4f normal = new Vec4f(animatedNormal[k], animatedNormal[k + 1], animatedNormal[k + 2], 0.0F);

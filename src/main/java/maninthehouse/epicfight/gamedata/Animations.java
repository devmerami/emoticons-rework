...
public final class Animations {
	...
	public static void registerAnimations(Side dist) {
		...
		BIPED_ROLL_FORWARD = new DodgingAnimation(1998, 0.09F, false, "biped/combat/roll_forward.dae", 0.6F, 0.5F, 1.5F).bindFull(biped);
		BIPED_ROLL_BACKWARD = new DodgingAnimation(1999, 0.09F, false, "biped/combat/roll_backward.dae", 0.6F, 0.5F, 1.5F).bindFull(biped);
		...
		GREATSWORD_DASH = new AADashAnimation(2011, 0.11F, 0.4F, 0.65F, 0.8F, 1.2F, null, "111213", "biped/combat/greatsword_dash.dae", 2.45F, false)
				.addProperty(AnimationProperty.LOCK_ROTATION, true).bindFull(biped);
		...
		AXE_DASH = new AADashAnimation(2019, 0.25F, 0.08F, 0.4F, 0.46F, 0.9F, null, "111213", "biped/combat/axe_dash.dae", 2.05F)
				.addProperty(AnimationProperty.LOCK_ROTATION, true).bindFull(biped);
		...
		SWORD_DUAL_DASH = new AADashAnimation(2023, 0.16F, 0.1F, 0.1F, 0.3F, 0.65F, Colliders.dualSwordDash, "", "biped/combat/dual_dash.dae", 1.55F)
				.addProperty(AnimationProperty.LOCK_ROTATION, true).bindFull(biped);

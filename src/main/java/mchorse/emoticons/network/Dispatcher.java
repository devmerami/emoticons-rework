...
import mchorse.emoticons.network.client.ClientHandlerEpicFightAction;
...
import mchorse.emoticons.network.server.ServerHandlerEpicFightAction;
...
public class Dispatcher
{
    public static final AbstractDispatcher DISPATCHER = new AbstractDispatcher(Emoticons.MOD_ID)
    {
        ...
        public void register()
        {
            ...
            register(PacketEpicFightAction.class, ClientHandlerEpicFightAction.class, Side.CLIENT);
            register(PacketEpicFightAction.class, ServerHandlerEpicFightAction.class, Side.SERVER);
        }
    };

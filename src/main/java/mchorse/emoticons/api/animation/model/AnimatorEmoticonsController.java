...
public class AnimatorEmoticonsController extends AnimatorController
{
    ...
    private static final ModelBiped DEFAULT_ARMOR_MODEL = new ModelBiped(1F);
    private static final ModelBiped DEFAULT_LEGGINGS_MODEL = new ModelBiped(0.5F);
    ...
    private void updateArmorSlot(String id, EntityLivingBase entity, EntityEquipmentSlot slot)
    {
        ...
        if (stack.getItem() instanceof ItemArmor)
        {
            ...
            config.visible = !this.usesCustomArmorModel(entity, stack, slot);
    ...
    private boolean usesCustomArmorModel(EntityLivingBase entity, ItemStack stack, EntityEquipmentSlot slot)
    {
        ModelBiped defaultModel = this.isLegSlot(slot) ? DEFAULT_LEGGINGS_MODEL : DEFAULT_ARMOR_MODEL;
        ModelBiped armorModel = ForgeHooksClient.getArmorModel(entity, stack, slot, defaultModel);

        return armorModel != null && armorModel.getClass() != ModelBiped.class;
    }
}

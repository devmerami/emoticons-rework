...
public class AnimatorController
{
    ...
    {
        this.renderOnScreen(player, x, y, scale, alpha, 45.0F, 45.0F);
    }

    public void renderOnScreen(EntityPlayer player, int x, int y, float scale, float alpha, float xRotation, float yRotation)
    {
        this.fetchAnimation();
